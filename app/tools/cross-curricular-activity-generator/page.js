  ...
  return (
    <>
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <p className="text-slate-500 mb-6">Create engaging activities that connect two subjects — with instructions, materials, and an assessment idea built in.</p>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pb-10">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          The tool also generates single activities, not integrated unit plans. For a multi-week cross-curricular unit, use this tool to generate individual activity sessions and sequence them using the <Link href="/unit-plan-creator" className="text-brand-700 hover:underline">Unit Plan Creator</Link>. For detailed daily lessons within the unit, the <Link href="/lesson-plan-generator" className="text-brand-700 hover:underline">Lesson Plan Generator</Link> builds out each session with full objectives, activities, and assessment.
        </p>

        <h2 className="text-xl font-semibold text-slate-800 mt-8 mb-3">Data Privacy and Classroom Use</h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          No student data is needed to use this tool. Inputs are subject, grade, topic, and duration — no identifying information. GogyAI stores no personal information and does not retain your inputs after the session. Find all free planning tools at <Link href="/" className="text-brand-700 hover:underline">free AI tools library on GogyAI</Link>.
        </p>
        ...
        <div className="space-y-5">
          {[
            ...
            { q: 'How long should a cross-curricular activity be?', a: <>A single session works well at 45–90 minutes. Extended cross-curricular projects can span multiple weeks. Use the <Link href="/unit-plan-creator" className="text-brand-700 hover:underline">Unit Plan Creator</Link> for multi-session cross-curricular units.</> },
