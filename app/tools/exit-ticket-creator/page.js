  ...
  return (
    <>
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <p className="text-slate-500 mb-6">Generate 2-3 ready-to-use exit ticket options to close any lesson — with assessment notes and follow-up guidance.</p>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pb-10">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          Exit tickets generated by AI are calibrated to general grade-level content knowledge. They may reference terminology or concepts slightly outside what you covered in a specific lesson. Always review the generated prompt to ensure it aligns with exactly what students practiced — not a broader topic area. For a more comprehensive assessment with multiple questions and an answer key, the <Link href="/quiz-mcq-generator" className="text-brand-700 hover:underline">Quiz MCQ Generator</Link> creates full multiple-choice quizzes at any difficulty level.
        </p>
        <p className="text-slate-700 leading-relaxed mb-4">
          The tool generates text-based prompts. Drawing prompts describe what students should draw — the actual drawing medium (paper, whiteboard, digital tool) is something you provide in the classroom. The AI cannot create the graphic organizer or visual template that a drawing prompt might benefit from; that supplementary material is yours to design. To plan the full lesson this exit ticket checks at the close, the <Link href="/lesson-plan-generator" className="text-brand-700 hover:underline">Lesson Plan Generator</Link> builds a complete plan with objectives, activities, and built-in formative assessment.
        </p>

        <h2 className="text-xl font-semibold text-slate-800 mt-8 mb-3">Data Privacy and Classroom Use</h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          No student data is needed to generate exit tickets. Enter only your subject, grade, lesson topic, and type. GogyAI stores no personal information. Inputs are used only during your session and are not retained. Discover <Link href="/" className="text-brand-700 hover:underline">the full GogyAI toolkit</Link> — 30 free tools for lesson planning, assessment, communication, and classroom management.
        </p>
